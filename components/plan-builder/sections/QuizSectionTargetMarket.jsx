...
export default function QuizSectionTargetMarket({
  currentSection = 3,
  totalSections = 11,
  defaultValues = {},
  onSubmit,
  ...
  const [values, setValues] = useState({
    ...
    marketSize: defaultValues.marketSize || "",
  });
  ...
  const valid = !!values.targetAudience.trim();
        ...
        >
          ...
          <header className="text-center space-y-3 mb-6">
            ...
            <p className="text-transparent bg-clip-text bg-gradient-to-r from-slate-600 to-indigo-600">
              Identify and describe your ideal customers
            </p>
          </header>
          ...
          <form onSubmit={handleSubmit} onKeyDown={handleKeyDown} className="space-y-8">
            ...
            >
              <Lift>
                <Textarea
                  ...
                  onChange={(e) =>
                    setValues((v) => ({ ...v, targetAudience: e.target.value }))
                  }
              ...
              <div className="mt-2">
                <SuggestedAudience
                  ...
                  active={showSuggest}
                  onPick={(text) =>
                    setValues((v) => ({ ...v, targetAudience: text }))
                  }
                  className="mt-1"
                />
              </div>

              {submitted && !values.targetAudience.trim() && (
            ...
            {/* Geo market (optional) */}
            <Field
              label="What's your target geographic market? (optional)"
            ...
            <Field
              label="What's your estimated market size? (optional)"
            ...
            >
              <Lift>
                <Input
                  ...
                  onChange={(e) =>
                    setValues((v) => ({ ...v, marketSize: e.target.value }))
                  }
            ...
            <AnimatePresence>
              {submitted && valid && (
                ...
                >
                  <CheckCircle2 className="h-4 w-4" /> Saved. Onward!
                </motion.div>
              )}
            </AnimatePresence>
          </form>
...
/* ---------- Aurora background (performance-tuned like others) ---------- */
